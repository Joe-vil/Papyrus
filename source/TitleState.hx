...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		dadsaw = new FlxSprite(0).loadGraphic(Paths.image('ui/menu-bg', 'papyrus'));
		...
		gfDance = new FlxSprite(456.1, -226.8);
		gfDance.frames = Paths.getSparrowAtlas('stage/gf-stand', 'papyrus');
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 5:
				if (Main.watermarks)
					createCoolText(['crappy papyrus', 'mod']);
			case 7:
				if (Main.watermarks)
					addMoreText('hehehehe');
				else
				{
