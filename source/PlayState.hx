...
class PlayState extends MusicBeatState
{
	...
	private var gfpaps:Bool = false;
	private var bfpaps:Bool = false;
	private var gfpaps2:Bool = false;
	private var bfpaps2:Bool = false;
		...
		switch(SONG.stage)
		{
			...
			case 'stage':
				...
				case 'papys':
				{
						...
						var bg2:FlxSprite = new FlxSprite(-912.3, -1032.9).loadGraphic(Paths.image('stage/snowback', 'papyrus'));
						bg2.antialiasing = true;
						bg2.scrollFactor.set(0.9, 0.9);
						bg2.active = false;
	
						var stageFront2:FlxSprite = new FlxSprite(-496.1, -1252.7).loadGraphic(Paths.image('stage/snowfront', 'papyrus'));
